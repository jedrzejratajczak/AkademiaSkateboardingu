...
const About = () => (
  <div className="p-10 gap-10 flex flex-col md:flex-row items-center">
    ...
    <div className="text-sm md:text-base lg:text-xl flex flex-col gap-5 uppercase">
      <p>
        Cześć, nazywam się Adam Szulc i od 13 lat jeżdżę na deskorolce, która z
        czasem z prostej zajawki zmieniła się w nieodłączną część mojego życia.
      </p>
      <p>
        Poza czystą przyjemnością z jazdy, pozwoliła mi ona zmienić sposób
        postrzegania świata, poznać wspaniałych ludzi z różnych zakątków polski
        i świata, oraz trafić w nowe miejsca.
      </p>
      <p>
        W 2021 roku zacząłem uczyć jazdy, żeby móc dzielić się doświadczeniami z
      ...
      <p>
        ...
        jest odkrywanie rzeczy, o których nie wiedziałeś, że ich szukasz” - Jack
        Sabback
      </p>
    </div>
  </div>
